...
func (h *AuthHandler) Register(w http.ResponseWriter, r *http.Request) {
	...
	// VULN #5: User enumeration — different error messages reveal which field is duplicate
	...
	// VULN #4: Mass assignment — user-supplied points_balance is passed through
...
func (h *AuthHandler) ForgotPassword(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	// VULN #6: Reset token leaked in response body
